...
var hydration = require('nesthydrationjs')();
var PREVENT_EXTRA_SPACE_CHARACTERS_INPUT = new Set([' ', ')', ',']);
var PREVENT_EXTRA_SPACE_CHARACTERS_TOKENS = new Set([' ', '(']);

var NestPromise = function (_Promise) {
    _inherits(NestPromise, _Promise);

    function NestPromise(executor) {
        _classCallCheck(this, NestPromise);

        return _possibleConstructorReturn(this, (NestPromise.__proto__ || Object.getPrototypeOf(NestPromise)).call(this, function (resolve, reject) {
            return executor(resolve, reject);
        }));
    }

    _createClass(NestPromise, [{
        key: 'then',
        value: function then(onFulfilled, onRejected) {
            var _this2 = this;

            var returnValue = _get(NestPromise.prototype.__proto__ || Object.getPrototypeOf(NestPromise.prototype), 'then', this).call(this, onFulfilled, onRejected);
            return returnValue.then(function (res) {
                return _this2.isFirst ? res[0] : res;
            });
        }
    }, {
        key: 'first',
...
var Lego = function () {
    ...
    _createClass(Lego, [{
        ...
        value: function nest() {
            ...
            return new NestPromise(function (resolve, reject) {
                _this3.execute().then(function (rows) {
